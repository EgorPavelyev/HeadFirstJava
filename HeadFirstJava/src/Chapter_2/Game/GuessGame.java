...
//        Создаем три объекта Player и присваиваем их трем переменным экземпляра
        ...
        p2 = new Player();
        p3 = new Player();
//        Объявим три переменных для хранения вариантов от каждого игрока
        int guessp1 = 0;
        int guessp2 = 0;
        int guessp3 = 0;
...
//            Вызываем метод gues() из каждого объекта Player
            p1.guess();
            p2.guess();
            p3.guess();
...
//            Если игрок угадал, то присваиваем соответствующей переменной значение true (по умолчанию она false)
...
//            Если 1 или 2 или 3 игрок угадал
...
//                Игра оконченаа, прекращаем цикл
                break;                
            }
            else{
